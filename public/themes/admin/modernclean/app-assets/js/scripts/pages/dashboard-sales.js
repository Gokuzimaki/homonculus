/*=========================================================================================
    ...
    var myDoughnutChart = new Chart(ctx, {
        ...
        data: {
            labels: ["Tiered Members","Normal Member"],
            datasets: [{
                label: "Favourite",
                backgroundColor: ["#28D094", "darkred"],
                data: [18, 82],
            }]
        },
        options: {
    ...
    var myDoughnutChart = new Chart(ctx, {
        type: 'dealsDoughnut',
        data: {
            labels: ["Landmark Beach", "Landmark Hotel","Go Kart Arena"],
            datasets: [{
                label: "Favourite",
                borderWidth: 0,
                backgroundColor: ["#c30c0c", "#ffd478", "#25386e"],
                data: [36, 20, 44],
            }]
        },
        options: {
    ...
    //Total Earnings
    if(typeof document.getElementById("earning-chart")!=="undefined"&&document.getElementById("earning-chart")!==null&&document.getElementById("earning-chart").length>0){
    ...
    //Sessions by Browser
    // -----------------------------------
    if(document.getElementById("sessions-browser-donut-chart")!==null){  
        Morris.Donut({
