...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.separator = ' - ';
        // console.log(moment(),moment()._weekdaysMin);

        /*if(typeof moment()._lang!=="undefined"){
        	var weekdayslice=moment()._lang._weekdaysMin.slice();
        }else{
        	var weekdayslice=["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"].slice();
        }
        if(typeof moment()._lang!=="undefined"){
        	var monthshortslice=moment()._lang._monthsShort.slice();
        }else{
        	var monthshortslice=moment().monthsShort().slice();
        }*/
        ...
        this.locale = {
            ...
            /*daysOfWeek: weekdayslice,
            monthNames: monthshortslice,*/
