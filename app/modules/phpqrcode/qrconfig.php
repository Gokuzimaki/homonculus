 ...
 */
	...
	// if true, estimates best mask (spec. default, but extremelly slow; 
	// set to false to significant performance boost but (probably) worst
	// quality code
	...
	// maximum allowed png image width (in pixels), tune to make sure GD 
	// and PHP can handle such big images
